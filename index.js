...
case 'sc':
case 'script':
  teksnya = `${namaBot}\nBot ini menggunakan script: https://github.com/GunturPrs/Bot-Me.v4 `
  textnya = `${Tanggal}`
nine.sendMessage(from, teksnya, textnya,{contextInfo :{text: 'hi',
  "forwardingScore": 1000000000,
  isForwarded: true,
  sendEphemeral: true,
  "externalAdReply": {
                ...
                "thumbnailUrl": "https://i.ibb.co/X8X7pW7/Guntur-P.jpg",
                "thumbnail": fakeImage,
                "sourceUrl": `https://github.com/GunturPrs/Bot-Me.v4`
},mentionedJid:[sender]}, quoted : mek})
break
...
case 'toimg':
	...
	buffer = fs.readFileSync(ran)
	nine.sendMessage(from, buffer, image, {quoted: mek, caption: response.success})
	fs.unlinkSync(ran)
	})
break
